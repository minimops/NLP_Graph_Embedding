...
```{r exGraph, fig.scap = "node2vec RW probability bias", fig.cap = "\\label{fig:exGraph}Example Graph to show the pobabilty bias of the node2vec RW. The labels on the edges represent the RW bias alpha, dependent on hyperparameters p and q. In this example, v represents the current node, while t the last visited node.", fig.align = "center"}
